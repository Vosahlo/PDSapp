...
const int POCET_STATU[] = {20, 25, 20, 25};
...
Stat staty[] = {
        ...
        Stat("Russian Federation", "ru", 4),
        Stat("Senegal", "sn", 4),
        Stat("Sweden", "se", 4),
        Stat("United Kingdom", "gb", 4),
        Stat("United States", "us", 4),
        Stat("Ukraine", "ua", 4),
        Stat("Uruguay", "uy", 4),
        Stat("Denmark", "dk", 4),
        Stat("Germany", "de", 4),
        ...
        Stat("Iraq", "iq", 4),
        Stat("Israel", "il", 4),
        Stat("Saudi Arabia", "sa", 4),
        Stat("Singapore", "sg", 4),
        Stat("South Korea", "kr", 4),
        Stat("United Arab Emirates", "ae", 4)
